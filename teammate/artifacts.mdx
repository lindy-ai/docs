...
<Frame>
  <img src="/lindy-brand-assets/teammate/artifact-ad-spend-report.png" alt="Lindy in #metrics: asked to pull this week's ad spend report, it pulls spend from three tools and posts a Paid spend card with spend, ROAS and CPA, a flagged campaign, and an Open the full report button linking to the artifact" />
</Frame>
