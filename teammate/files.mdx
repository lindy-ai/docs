...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/teammate/new-file.mp4"
      autoPlay
      muted
      loop
      playsInline
...
<Frame>
  <img src="/lindy-brand-assets/teammate/files-memory-compliance.png" alt="A memory folder holding a references folder with team.md and tools.md, beside meetings, marketing, and engineering folders, next to GDPR, AICPA SOC 2, HIPAA, and PIPEDA compliance badges" />
</Frame>
