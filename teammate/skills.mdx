...
<Frame>
  <img src="/lindy-brand-assets/teammate/skills-shared-tree.png" alt="A skills folder holding 42 shared skills, each taught by a teammate: account-research taught by Tamara, containing how-we-qualify.md and sources.md, alongside funnel-review taught by Priya, qbr-deck taught by Marcus, and channel-catch-up taught by Dana. Lindy reads these on its own, with nothing to switch on" />
</Frame>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/teammate/skills-page.mp4"
      autoPlay
      muted
      loop
      playsInline
...
<Tabs>
  <Tab title="In chat">
    ...
    <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
      <div className="video-card">
        <video
          src="/lindy-brand-assets/teammate/skill-create-in-chat.mp4"
          autoPlay
          muted
          loop
          playsInline
  ...
  <Tab title="On the Skills page">
    ...
    <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
      <div className="video-card">
        <video
          src="/lindy-brand-assets/teammate/createskillonpage.mp4"
          autoPlay
          muted
          loop
          playsInline
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/teammate/skills-scopes-discover.mp4"
      autoPlay
      muted
      loop
      playsInline
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/teammate/skill-in-action.mp4"
      autoPlay
      muted
      loop
      playsInline
