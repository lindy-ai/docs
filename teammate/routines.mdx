...
description: "Lindy routines turn your recurring work into hands-off automation"
icon: "clock-rotate-left"
---

<Frame>
  <img src="/lindy-brand-assets/teammate/routines-card.png" alt="Four routines running without anyone configuring them: Daily briefs prepping your day by 8am, Email drafting writing replies in your voice, Meeting notes filed from every call, and Follow-up bumps nudging the people who ghosted, above a New routine button noting that a sentence is all it takes" />
</Frame>

Lindy routines turn your recurring work into hands-off automation — set a schedule or trigger once, and Lindy runs the whole job for you on autopilot, from pulling data and drafting messages to updating your tools, so you never have to remember or repeat it again.

Each routine is three parts: a **trigger** (when it runs), a **prompt** (what to do, in plain English), and a **destination** (where the result goes). It isn't a separate bot, it's automation attached to your Lindy, which is what makes Lindy proactive: briefing you, prepping you for meetings, and tracking follow-ups without being asked.
...
| **Meeting Recording** | Joins your meetings and takes notes |
