...
There are two ways to interact with Lindy in Slack: **@mention** it when you want a response, or use a **slash command** to manage your connection.

<Tip>
  For anything private, DM Lindy instead: press **⌘ + K**, type **Lindy**, and select **Lindy · App**. See [Find Lindy and DM it](/teammate/setup#find-lindy-and-dm-it).
</Tip>
...
<Frame>
  <img src="/lindy-brand-assets/teammate/artifact-ad-spend-report.png" alt="A teammate @mentions Lindy in #metrics to pull this week's ad spend report; Lindy pulls spend from three tools and replies in the channel with a Paid spend card, a flagged campaign, and a button to open the full report" />
</Frame>

Once Lindy has replied in a thread, you don't need to keep @mentioning it. Lindy reads the thread and disambiguates whether your next message is aimed at it or at the other people in the conversation, so a natural follow-up keeps the thread going without the extra @mention.
