...
<Tabs>
  <Tab title="Individual Pro Plans">
    Each team member has their own Lindy Pro subscription and usage allowance. You can still collaborate in a shared workspace, but billing is per-user.
  </Tab>
