...
<Frame>
  <img src="/lindy-brand-assets/edit credit limit june 11.png" alt="Members table in Members and Groups with per-row menu showing 'Edit credit limit' and 'Deactivate membership' options" />
</Frame>
