...
A task is everything Lindy does after being triggered by an event or user message. Tasks begin when a workflow is initiated and include all subsequent steps - conditions, actions, AI agent steps, and messages.
...
<Warning>
Credits do not roll over between billing cycles. When you run out of credits, Lindy pauses operations and new tasks are put on hold.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Credit Optimizations" icon="chart-line" href="/account-billing/credit-optimizations">
    Learn advanced strategies to reduce credit consumption
  </Card>
  
  <Card title="Workspaces" icon="building" href="/account-billing/workspaces">
    Manage multiple projects and their credit usage
  </Card>
  
  <Card title="Teams" icon="users" href="/account-billing/teams">
    Understand team billing and credit sharing
  </Card>
