...
<Note>
This page covers credits for **custom agents** built in the workflow editor. If you're using Lindy and saw a usage warning, see [Understanding Your Usage](/account-billing/usage).
</Note>
