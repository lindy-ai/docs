...
This page covers what actually uses credits, why Lindy sometimes pauses to check in, and what to do if your team needs more. For seats, pricing, and trials, see [Lindy Teammate Billing](/teammate/lindy-teammate-billing).
...
<CardGroup cols={2}>
  <Card title="Lindy Teammate Billing" icon="credit-card" href="/teammate/lindy-teammate-billing">
