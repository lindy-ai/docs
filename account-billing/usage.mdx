...
The simplest way to reduce usage is to switch the model in your conversations to a more cost-effective option. You can find more strategies in the [Credit Optimization](/account-billing/credit-optimizations) guide.
