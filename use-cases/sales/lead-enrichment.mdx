...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="https://lindy-docs-content.nyc3.digitaloceanspaces.com/lead-enrichment.mp4"
      width="600"
      autoPlay
      muted
      loop
...
<AccordionGroup>
  <Accordion title="Set Up Your Columns First">
    Create all output columns in your sheet before starting - Lindy needs them to exist.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Outbound Campaigns" href="/tutorials/outbound-campaigns" icon="paper-plane">
    Use enriched data for personalized outreach
  </Card>
  <Card title="Lead Scoring" href="/tutorials/lead-scoring" icon="star">
  ...
  <Card title="Competitive Intel" href="/tutorials/competitive-research" icon="magnifying-glass-chart">
