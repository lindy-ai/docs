...
DescriptionL 'Never miss a detail again – let Lindy automatically join your meetings, take notes, and organize them for easy access.'
---
...
Once you've clciked on the Meeting Notetaker template to your account, open the Flow Editor to see how it works. Let's walk through each step to customize it for your needs.
