...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/pw_meeting_assistant.mp4"
      width="600"
      autoPlay
      muted
      loop
...
<Tip>
  Pro tip: Use filters to have your agent only join specific types of meetings. This prevents Lindy from joining every calendar event, like personal appointments.
</Tip>
