...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/pw_calendar_prep.mp4"
      width="600"
      autoPlay
      muted
      loop
...
### Step 2: Check If It's an External Meeting
...
```
Tell me about [attendee's name] at [attendee company]. Include their current role, background, recent professional updates, and any recent company news.
```
...
Query: `from:[attendee's email]` using a prompt
