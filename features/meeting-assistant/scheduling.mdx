...
<Steps>
  <Step title="Someone emails you asking for a time to meet">
    ...
    <Frame>
      <img src="/lindy-brand-assets/meeting1.png" alt="Incoming email requesting a meeting" />
    </Frame>
  </Step>
  <Step title="Lindy replies with 3 available times">
    ...
    <Frame>
      <img src="/lindy-brand-assets/meeting2.png" alt="Lindy's reply with 3 available time slots" />
    </Frame>
  </Step>
  <Step title="They click a time and it's instantly booked">
    ...
    <Frame>
      <img src="/lindy-brand-assets/meeting3.png" alt="Meeting booked on calendar after clicking a time slot" />
    </Frame>
  </Step>
</Steps>
