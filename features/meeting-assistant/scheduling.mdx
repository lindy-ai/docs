...
<Steps>
  <Step title="Someone emails you asking for a time to meet">
    ...
    <img src="/lindy-brand-assets/scheduling1.png" alt="Incoming email requesting a meeting" style={{ width: '130%', marginLeft: '-15%', borderRadius: '12px' }} />
  </Step>
  <Step title="Lindy replies with 3 available times">
    ...
    <img src="/lindy-brand-assets/schedulingv2.png" alt="Lindy's reply with 3 available time slots" style={{ width: '130%', marginLeft: '-15%', borderRadius: '12px' }} />
  </Step>
  <Step title="They click a time and it's instantly booked">
    ...
    <img src="/lindy-brand-assets/scheduling3.png" alt="Meeting booked on calendar after clicking a time slot" style={{ width: '130%', marginLeft: '-15%', borderRadius: '12px' }} />
  </Step>
</Steps>
