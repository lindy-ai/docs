...
<div style={{ background: 'rgba(58, 96, 255, 0.08)', border: '1px solid rgba(58, 96, 255, 0.15)', borderRadius: '8px', padding: '14px 18px', color: '#3A60FF', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '0.95em', margin: '12px 0 20px' }}>
