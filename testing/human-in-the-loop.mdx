...
- **Agent pauses** - Lindy will execute up to that action, then wait for your approval
...
- **Agent continues** - Once approved, Lindy completes the workflow
...
- **Get notified** - Receive a ping saying "Hey, your Lindy agent is stuck and needs help"
...
<CardGroup cols={2}>
  <Card title="Test Panel" icon="play" href="/testing/test-panel">
    Test your agents with human oversight enabled
  </Card>
  ...
  <Card title="Agent Settings" icon="gear" href="/building-agents/agent-basics/agent-settings">
    Configure your agent's behavior and permissions
  </Card>
</CardGroup>