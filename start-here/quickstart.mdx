...
Triggers wake up your AI agent when something happens, like getting a new email. [Learn more about triggers](/core-concepts/triggers).

<Tip>
Use filters to make your triggers more specific and reduce costs. [Learn about cost optimization](https://docs.lindy.ai/account-billing/credit-optimizations).
</Tip>
