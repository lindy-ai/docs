...
<Steps>
  ...
  <Step title="Add knowledge base">
    Add your website as a knowledge base for accurate responses
  </Step>
  <Step title="Add actions">
    Add a Gmail action to send automated replies
  </Step>
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/select_gmail-trigger.mp4" 
      width="600"
      autoPlay
      muted
      loop
