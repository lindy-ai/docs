...
Configure Lindy's behavior through the web interface, or simply ask it in plain language — it'll update the settings for you and tell you where to fine-tune.
