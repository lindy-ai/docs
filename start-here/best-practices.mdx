...
<div style={{ borderRadius: '20px', overflow: 'hidden', maxWidth: '75%', margin: '0 auto' }}>
  <video src="/lindy-brand-assets/pin_video.mov" autoPlay muted loop playsInline style={{ display: 'block', width: '100%', maxHeight: 'none' }} />
</div>
