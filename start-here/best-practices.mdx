...
<Note>
  **These are for your personal Lindy** — the one in your DMs that knows your inbox, calendar, and meetings. The more it knows about you, the less it has to ask. The Lindy your team shares works differently: see [Slack Commands](/teammate/slack-commands).
</Note>
...
Lindy gets better the more you use it. If it gets anything wrong, just share quick feedback and it'll learn from it.
...
## Text Lindy Like You'd Text a Human Assistant

Tell Lindy the outcome: it handles the back-and-forth.
...
"Remind me Friday." "Tell me when Sarah replies." "Follow up with Acme if they go quiet for a week." Hand it the loop, then forget it.
...
The more Lindy knows about you, the better it can help. Open iMessage, **hit the voice button**, and brief it like a new hire: five minutes covers a lot.
