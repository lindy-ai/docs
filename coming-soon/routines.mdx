...
<Frame>
  <img src="/lindy-brand-assets/teammate/routine-set-flow.png" alt="Asking Lindy for the latest growth numbers, getting signups up 18 percent and activation up 6 percent with churn flat, then saying to do this every morning at 9am, and the routine is set and active" />
</Frame>
