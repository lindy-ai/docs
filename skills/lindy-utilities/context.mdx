...
<CardGroup cols={2}>
  <Card title="Set Variables" icon="gear" href="/skills/lindy-utilities/set-variables">
    Learn how to store temporary data that doesn't need to be in global context
  </Card>
  
  <Card title="Memories" icon="brain" href="/skills/lindy-utilities/memories">
    Understand persistent memory that survives across different task executions
  </Card>
  
  <Card title="Get Task" icon="list" href="/skills/lindy-utilities/get-task">
    Access task-level information and execution details
  </Card>
  
  <Card title="LLM Call" icon="message-lines" href="/skills/lindy-utilities/llm-call">
