...
<Steps>
  <Step title="Add WhatsApp to your workflow">
    Click on the plus sign at the bottom or right-click anywhere on the canvas and select "Add Trigger" or "Add Action" from the pop-up menu and choose "WhatsApp"
    <Frame>
      <img src="/lindy-brand-assets/google_calendar_1.png" alt="Add WhatsApp to workflow" />
    </Frame>
  </Step>
  <Step title="Connect and Configure your WhatsApp">
    Click on "Add Account" and authorize your WhatsApp for Lindy's integrations. For WhatsApp Business, provide your Business Account ID, Access Token, and Phone Number ID. For personal WhatsApp, follow the authentication process.
    <Frame>
      <img src="/lindy-brand-assets/google_calendar_2.png" alt="WhatsApp connection" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/lindy-brand-assets/google_calendar_3.png" alt="Message Received trigger" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/google_calendar_4.png" alt="New Message Sent trigger" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/google_calendar_11.png" alt="List Message Templates action" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Twilio Integration" icon="twilio" href="/skills/popular-integrations/twilio">
    Combine WhatsApp with SMS and voice automation
  </Card>
  <Card title="Telegram Integration" icon="telegram" href="/skills/popular-integrations/telegram">
