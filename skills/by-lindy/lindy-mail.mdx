...
description: 'Send emails from your Lindy workflows with custom templates and dynamic content'
keywords: ['email', 'mail', 'send email', 'outbound', 'compose', 'draft email', 'email action', 'outreach']
---
...
Key benefits:
- **Dedicated inbox** — Lindy gets its own email address
...
Add the "Lindy Mail Email Received" trigger to have Lindy wake up when emails arrive at its address.
...
<AccordionGroup>
  <Accordion title="Support Inbox">
    Give your agent a support@company.ai address to handle first-line customer inquiries
  </Accordion>
