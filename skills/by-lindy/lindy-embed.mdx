...
<CardGroup cols={2}>
  <Card title="Test Your Embed" href="/building-agents/agent-basics/testing-agents" icon="vial">
    Test your embedded agent before going live
  </Card>
  <Card title="Configure Agent" href="/building-agents/agent-basics/agent-settings" icon="cog">
    Fine-tune your agent's behavior and responses
  </Card>
  <Card title="Add Knowledge" href="/fundamentals/lindy-101/knowledge-base" icon="database">
    Enhance your agent with specific knowledge
  </Card>
  <Card title="Monitor Performance" href="/testing/monitoring-your-agents" icon="chart-line">
