...
keywords: ['embed', 'chatbot', 'widget', 'website', 'iframe', 'popup', 'webflow', 'wix', 'squarespace', 'wordpress', 'website chatbot', 'live chat']
---
...
<Frame>
  <img 
    ...
    style={{ borderRadius: '8px', border: '1px solid #C4D0DC' }}
  />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-embed-testing-1.png" alt="Lindy Embed testing interface showing the preview and test conversation options" />
</Frame>

After sending a test message, return to the test panel and click the incoming message to continue the conversation.

<Frame>
  <img src="/lindy-brand-assets/lindy-embed-test-msg.png" alt="Lindy Embed testing interface showing the incoming message to select" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-embed-view-chatbot-flow.png" alt="Lindy Embed chatbot flow monitoring showing conversation logs and user interactions" />
</Frame>
