...
- **Error handling** - Use try-catch blocks to handle potential failures
- **Variable validation** - Check variable types and values before processing
- **Efficient code** - Optimize for performance, especially with large datasets
- **Clear returns** - Return structured data that's easy to use in subsequent steps
