...
keywords: ['webhook', 'callback', 'trigger', 'api']
---
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-add-trigger.png" alt="Add Trigger menu showing Webhook option in popular triggers and other triggers sections" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-show-fields-to-fill.png" alt="Webhook configuration interface showing webhook selection and follow-up behavior options" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-follow-up-behavior.png" alt="Follow-up behavior dropdown showing Handle in same task, Create new task, and Ignore options" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-create-webhook.png" alt="Create new webhook interface with name field and webhook list" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhok-generate-secret.png" alt="Generate Secret button and copy to clipboard option for webhook security" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-secret-generated.png" alt="Secret key display with warning that it's only shown once" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-ai-agent.png" alt="Webhook trigger followed by AI Agent node in workflow" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-webhook-ai-agent-skills.png" alt="AI Agent skills panel showing Send POST Request to Callback as a suggested skill" />
</Frame>
