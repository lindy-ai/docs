...
keywords: ['timer', 'schedule', 'delay', 'wait', 'cron']
---
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-add-trigger.png" alt="Add Trigger menu showing Timer in the popular section" />
</Frame>

Timer appears in the "Popular" triggers section, offering two powerful scheduling options:

<Frame>
  <img src="/lindy-brand-assets/lindy-timer-trgger-options.png" alt="Timer trigger options showing On Recurring Schedule and On Specific Time" />
</Frame>

### On Recurring Schedule

<Frame>
  <img src="/lindy-brand-assets/lindy-timer-recurring-schedule-trigger.png" alt="Recurring schedule configuration with preset intervals and next run times" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-on-specific-time-trigger.png" alt="Specific time trigger with calendar date picker and time selector" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-avaialble-actions.png" alt="Timer actions menu showing Cancel Timers and Set Timer options" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-set-timer-until-actions.png" alt="Set Timer action configured to wait until a specific date and time" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-set-timer-for-actions.png" alt="Set Timer action configured to wait for a specified number of minutes" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-set-timer-actions-ai-prompt.png" alt="Set Timer with Prompt AI mode for intelligent timing decisions" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-timer-cancel-timer-action.png" alt="Cancel Timers action to stop all active timers" />
</Frame>
