...
When it finds a virtual meeting link, Lindy automatically joins and you'll see two execution paths:
...
Lindy joins as "Lindy Meeting Notetaker" and records everything with real-time transcription.
