...
keywords: ['meeting recorder', 'recording', 'transcription', 'notetaker', 'transcript', 'action items', 'meeting summary', 'call recording', 'microsoft teams', 'zoom', 'google meet', 'record teams meeting', 'record zoom meeting', 'record google meet']
---
...
<Frame>
  <img src="/lindy-brand-assets/lindy-meeting-recorder.png" alt="Meeting Recorder workflow showing Calendar trigger, recording, and follow-up actions" />
</Frame>

## How It Works

The input is a virtual meeting link. When set to auto, it'll join automatically when any Google Meet, Zoom, or Microsoft Teams link is in its context. Below is how a Lindy with the `Meeting Recorder` is usually structured:
