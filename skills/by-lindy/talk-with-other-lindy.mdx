...
<CardGroup cols={2}>
  <Card title="Agent Settings" href="/building-agents/agent-basics/agent-settings" icon="robot">
    Configure your Lindys for optimal communication
  </Card>
  <Card title="Creating Agents" href="/building-agents/agent-basics/creating-agents" icon="wand-magic-sparkles">
    Build specialized Lindys for different workflow stages
  </Card>
  <Card title="Context Management" href="/skills/lindy-utilities/context" icon="list">
