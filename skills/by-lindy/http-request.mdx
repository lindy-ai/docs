...
description: 'Execute custom API calls and webhooks directly from your agent workflows'
keywords: ['http', 'api', 'request', 'rest', 'endpoint', 'webhook']
---
...
<Frame>
  <img src="/lindy-brand-assets/lindy-http-request.png" alt="HTTP Request action in the Add Action menu under Popular and By Lindy categories" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-http-method.png" alt="HTTP method dropdown showing GET, POST, PUT, PATCH, DELETE options" />
</Frame>
...
<Frame>
  <img src="/lindy-brand-assets/lindy-http-headers.png" alt="Headers configuration showing key-value pairs with Content-Type example" />
</Frame>
...
<Tabs>
  <Tab title="Auto Mode">
    <Frame>
      <img src="/lindy-brand-assets/lindy-http-body.png" alt="Body field in Auto mode with AI assistance" />
    </Frame>
  ...
  <Tab title="Prompt AI Mode">
    <Frame>
      <img src="/lindy-brand-assets/lindy-http-request-body-prompt-example.png" alt="Body field using Prompt AI mode to create a complex search query" />
    </Frame>
