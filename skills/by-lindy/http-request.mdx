...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="https://lindy-docs-content.nyc3.digitaloceanspaces.com/http-request-demo.mp4"
      width="600"
      autoPlay
      muted
      loop
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
  <div className="video-card">
    <video
      src="/lindy-brand-assets/lindy-http-fields-video.mp4"
      width="600"
      autoPlay
      muted
      loop
...
<CardGroup cols={2}>
  <Card title="Use Variables" icon="brackets-curly">
    Reference data from previous steps using `{{variable_name}}` syntax
  </Card>
  
  <Card title="Test First" icon="flask">
    Use webhook.site or similar tools to test your requests before going live
  </Card>
  
  <Card title="Handle Errors" icon="shield-exclamation">
    Always add error handling conditions after API calls
  </Card>
  
  <Card title="Secure Secrets" icon="key">
    Store API keys in Lindy's secure credential manager, not in plain text
  </Card>
</CardGroup>
