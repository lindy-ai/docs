              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg flex flex-col items-center text-center h-20">
                  <div className="flex-1 flex items-end pb-1">
                    <Icon icon="bolt" className="text-gray-600 dark:text-slate-400" />
                  </div>
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg flex flex-col items-center text-center h-20">
                  <div className="flex-1 flex items-end pb-1">
                    <Icon icon="arrow-pointer" className="text-gray-600 dark:text-slate-400" />
                  </div>
                  <div className="flex-1 flex items-start pt-1">
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg flex flex-col items-center text-center h-20">
                  <div className="flex-1 flex items-end pb-1">
                    <Icon icon="brain-circuit" className="text-gray-600 dark:text-slate-400" />
                  </div>
                  <div className="flex-1 flex items-start pt-1">
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg flex flex-col items-center text-center h-20">
                  <div className="flex-1 flex items-end pb-1">
                    <Icon icon="plug" className="text-gray-600 dark:text-slate-400" />
                  </div>
                  <div className="flex-1 flex items-start pt-1">
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg flex flex-col items-center text-center h-20">
                  <div className="flex-1 flex items-end pb-1">
                    <Icon icon="network-wired" className="text-gray-600 dark:text-slate-400" />
                  </div>
                  <div className="flex-1 flex items-start pt-1">
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg flex flex-col items-center text-center h-20">
                  <div className="flex-1 flex items-end pb-1">
                    <Icon icon="arrows-repeat" className="text-gray-600 dark:text-slate-400" />
                  </div>
                  <div className="flex-1 flex items-start pt-1">
