...
<Steps>
  ...
  <Step title="Build your first agent">
    Follow our [step-by-step guide](/fundamentals/lindy-101/create-agent) to create your first custom agent
  </Step>
...
<CardGroup cols={2}>
  <Card title="Create a Custom Agent" href="/fundamentals/lindy-101/create-agent" icon="plus">
