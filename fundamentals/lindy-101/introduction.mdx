  ...
  <div className="max-w-4xl mx-auto border border-yellow-400 dark:border-yellow-500 rounded-xl p-6">
    ...
    <div className="flex items-center justify-between mb-6">
      <div className="flex items-center gap-3">
        ...
        <span className="font-medium text-gray-900 dark:text-white">Lindy</span>
      </div>
    ...
    <div className="bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg p-6">
      <div className="flex items-center gap-3 mb-6">
        <Icon icon="users" className="text-yellow-600 dark:text-yellow-400" />
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-4">
              <Icon icon="sitemap" className="text-gray-600 dark:text-slate-400" />
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-4">
                <Icon icon="forward-step" className="text-yellow-600 dark:text-yellow-400" />
                <span className="text-sm font-medium text-gray-900 dark:text-white">Steps</span>
              </div>
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-3 text-center">
                  <Icon icon="bolt" className="mx-auto mb-2 text-gray-600 dark:text-slate-400" />
                  <p className="text-xs font-medium text-gray-900 dark:text-white">Triggers</p>
                </div>
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-3 text-center">
                  <Icon icon="arrow-pointer" className="mx-auto mb-2 text-gray-600 dark:text-slate-400" />
                  <p className="text-xs font-medium text-gray-900 dark:text-white">Actions</p>
                </div>
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-3 text-center">
                  <Icon icon="brain-circuit" className="mx-auto mb-2 text-gray-600 dark:text-slate-400" />
                  <p className="text-xs font-medium text-gray-900 dark:text-white">Agent Steps</p>
                </div>
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-3 text-center">
                  <Icon icon="plug" className="mx-auto mb-2 text-gray-600 dark:text-slate-400" />
                  <p className="text-xs font-medium text-gray-900 dark:text-white">Integrations</p>
                </div>
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-3 text-center">
                  <Icon icon="network-wired" className="mx-auto mb-2 text-gray-600 dark:text-slate-400" />
                  <p className="text-xs font-medium text-gray-900 dark:text-white">Conditions</p>
                </div>
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-3 text-center">
                  <Icon icon="arrows-repeat" className="mx-auto mb-2 text-gray-600 dark:text-slate-400" />
        ...
        <div>
          <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-4 h-full">
            <div className="flex flex-col items-center justify-center h-full gap-3">
              <Icon icon="database" className="text-gray-600 dark:text-slate-400" />
