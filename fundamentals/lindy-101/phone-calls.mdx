...
Enable your agents to make and receive phone calls autonomously in 30+ languages across 100+ countries.
...
<Frame>
  <div style={{ padding: '56.25% 0 0 0', position: 'relative' }}>
    <div style={{ background: '#f0f0f0', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <span style={{ color: '#666', fontSize: '18px' }}>Video: Phone Calls Overview</span>
    </div>
  </div>
</Frame>
...
<Note>
Phone calls are available on Pro, Business, and Enterprise plans. Pro plans are limited to 30 calls/month and English only.
</Note>
...
<Tip>
For phone actions inside AI agent nodes, use GPT-4o mini. For standalone phone workflows, use GPT-4 Turbo for best results.
</Tip>
