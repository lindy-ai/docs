...
A Knowledge Base is a repository that enables your agent to reference and retrieve data from multiple sources. Using hybrid semantic and keyword search, your agent intelligently queries your content to find relevant information for any task.
