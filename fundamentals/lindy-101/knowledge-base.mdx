...
Enable your agents to search and retrieve information from multiple data sources using intelligent semantic and keyword search.
...
<Frame>
  <div style={{ padding: '56.25% 0 0 0', position: 'relative' }}>
    <div style={{ background: '#f0f0f0', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <span style={{ color: '#666', fontSize: '18px' }}>Video: Knowledge Base Overview</span>
    </div>
  </div>
</Frame>
...
<CardGroup cols={2}>
  <Card title="Actions" href="/fundamentals/lindy-101/actions" icon="play">
  ...
  <Card title="Memory" href="/fundamentals/lindy-101/memory" icon="brain">
