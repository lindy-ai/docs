...
description: 'Choose how each action field should be filled: Auto, AI Prompt, or Set Manually.'
keywords: ['field configuration', 'auto mode', 'ai prompt mode', 'set manually', 'workflow fields']
---
