...
- **Contextual analysis**: Lindy reads and understands the referenced content to determine if the person is new or returning
...
The "+" button gives you instant access to ALL data from previous steps - forms, API responses, search results, and more. This powerful feature lets you connect any piece of information across your workflow.
