...
Define different paths in your workflow based on specific criteria to create dynamic, intelligent automations.
...
<CardGroup cols={2}>
  <Card title="Loops" href="/fundamentals/lindy-101/looping" icon="repeat">
