...
Conditions let you create branching logic in your workflows. They evaluate specific criteria and direct your agent down different paths based on the results. Think of them as "if-then" statements that make your automations smarter and more responsive to different scenarios.
...
<Note>
  Each condition branch should have a clear, distinct criteria. Your agent will evaluate all conditions and follow the first matching path.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Order Matters">
    Your agent evaluates conditions in order and takes the first matching path. Place more specific conditions before general ones.
  </Accordion>
