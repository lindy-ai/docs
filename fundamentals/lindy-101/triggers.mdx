...
<CardGroup cols={3}>
  <Card title="Time-based" icon="clock">
    Starts the workflow at a set or recurring time
  </Card>
  <Card title="Chat-based" icon="message-circle">
    Starts the workflow when a user initiates a chat
  </Card>
  <Card title="Event-based" icon="activity">
    Starts the workflow when a specific event occurs
  </Card>
</CardGroup>
...
If it is your first time setting up an app for a given trigger, you must authorize your desired account. Lindy supports multi-account authorization. You can select which account you want to use for the trigger in the Trigger Settings. The trigger will only fire for the selected account.
...
For example, if you wanted a Meeting Prep Lindy to prep you 10 minutes before a meeting, you would set the Minutes Offset to -10. In this case, the workflow would begin 10 minutes before the Calendar Event Start time.
