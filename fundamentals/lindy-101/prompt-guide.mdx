...
If your task is based on a template or previous example, instruct Lindy to use the same language or structure. Leverage Lindy's ability to maintain context throughout the workflow by referencing data from prior steps.

<Frame>
  <img 
    src="/lindy-brand-assets/reference_previous_steps_in_prompts.png" 
    alt="Referencing previous steps in prompts"
